...
実車での適用前に、対象車両の計測済みの値を配置してください。
初期同梱のゼロは実測値ではありません。A2・A3・A4・A6・A7 の計測値の記録は
[PR #346](https://github.com/AutomotiveAIChallenge/aichallenge-racingkart/pull/346) で扱います。
