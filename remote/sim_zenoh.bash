...
role="${1:?usage: sim_zenoh.bash {vehicle|remote} [domain_id]}"
...
remote)
    ...
    sed "s/__VEHICLE_ID__/${VEHICLE_ID}/g" /remote/zenoh-user-sim.json5.template >"${config}"
